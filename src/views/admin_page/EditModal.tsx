...
const EditModal: React.FC<ModalProps> = ({data, onClose, isOpen}) => { 
        ...
        <>
            ...
            >
                <div className="d-flex justify-content-between px-4 pt-4 pb-3">
                    ...
                    <div>
                        <label htmlFor="showing">Tampilkan pada halaman:</label>
                        <select
                            id="showing"
                            name="showing"
                            value={editedShowToggle}
                            required
                            onChange={(e) => setEditedShowToggle(e.target.value)}
                            >
